...
class GreenBot {
    ...
    addMessage(content, type, metadata = {}) {
        ...
        // Enhanced message content with messenger-style theme - Fixed for light and dark mode
        const messageContentClasses = type === 'user' ? 
            'chat-bubble-user message-content p-4 rounded-2xl max-w-lg shadow-sm border-0 ml-auto text-black ' : 
